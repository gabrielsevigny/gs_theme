...
if ( ! function_exists( 'gs_theme_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
...
add_action( 'woocommerce_before_main_content', 'gs_theme_woocommerce_wrapper_before' );

if ( ! function_exists( 'gs_theme_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
...
add_action( 'woocommerce_after_main_content', 'gs_theme_woocommerce_wrapper_after' );
...
if ( ! function_exists( 'gs_theme_woocommerce_cart_link_fragment' ) ) {
	...
	function gs_theme_woocommerce_cart_link_fragment( $fragments ) {
		ob_start();
		gs_theme_woocommerce_cart_link();
		$fragments['a.cart-contents'] = ob_get_clean();

		return $fragments;
	}
}
add_filter( 'woocommerce_add_to_cart_fragments', 'gs_theme_woocommerce_cart_link_fragment' );

if ( ! function_exists( 'gs_theme_woocommerce_cart_link' ) ) {
	/**
	 * Cart Link.
	 *
...
if ( ! function_exists( 'gs_theme_woocommerce_header_cart' ) ) {
	 ...
	 * @return void
	 */
	function gs_theme_woocommerce_header_cart() {
		if ( is_cart() ) {
